...
const CONTACT_LINKS = [
  {
    name: "Email",
    content: "contact@abdellah.dev",
    href: "mailto:contact@abdellah.dev",
    icon: <FaEnvelope height={"50px"} />,
  },
  {
    name: "WhatsApp",
    content: "+212 605 341 594",
    href: "https://wa.me/212605341594",
    icon: <FaPhone height={"50px"} />,
  },
  {
    name: "LinkedIn",
    href: "https://www.linkedin.com/in/abdellah-alioua-7b8289384/",
    content: "/abdellah-alioua",
    icon: <FaLinkedin height={"50px"} />,
  },
  {
    name: "GitHub",
    href: "https://github.com/ABDELLAH-H2",
    content: "/ABDELLAH-H2",
          ...
          >
            <div className="flex flex-row lg:flex-col items-center">
              ...
              <div className="flex flex-col gap-3 lg:items-center ml-10 md:ml-20 lg:ml-0">
                <p className="text-center text-xl">Abdellah Alioua</p>
