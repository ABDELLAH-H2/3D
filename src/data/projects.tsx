...
const projects: Project[] = [
  ...
  // Abdellah Alioua's Projects
  { // 01. Event Management System
    id: "gestion-evenements",
    category: "Full Stack",
    title: "Event Management System",
    src: "/assets/projects-screenshots/gestion-evenements/landing.png",
    screenshots: ["landing.png"],
    live: "https://github.com/ABDELLAH-H2/Gestion-d-v-nements",
    github: "https://github.com/ABDELLAH-H2/Gestion-d-v-nements",
    skills: {
  ...
  { // 02. Product Scraping Chrome Extension
    ...
    github: "https://github.com/ABDELLAH-H2/product-scraping",
    skills: {
      frontend: [PROJECT_SKILLS.js, PROJECT_SKILLS.html, PROJECT_SKILLS.css],
      backend: [],
    },
    get content() {
      return (
        <div>
          ...
          <ul className="list-disc ml-6 font-mono">
            <li>Extract product images and URLs automatically</li>
            <li>Capture product categories and descriptions</li>
  ...
  { // 04. Marrakech Shoes - E-commerce
    id: "marrakech-shoes",
    category: "E-commerce",
    title: "Marrakech Shoes",
    src: "/assets/projects-screenshots/marrakech-shoes/landing.png",
    screenshots: ["landing.png"],
    live: "https://marrakechshoes.com/",
    skills: {
    ...
    get content() {
      return (
        <div>
          <TypographyP className="font-mono text-2xl text-center">
            Marrakech Shoes - E-commerce Store
          </TypographyP>
          <TypographyP className="font-mono ">
            A custom e-commerce solution built with WordPress. Features include a fully
            responsive design, custom product filtering, and optimized checkout flow.
            Built for a premium shoe retail experience with WooCommerce integration.
          </TypographyP>
          <ProjectsLinks live={this.live} repo={this.github} />
          <TypographyH3 className="my-4 mt-8">Features</TypographyH3>
          <ul className="list-disc ml-6 font-mono">
